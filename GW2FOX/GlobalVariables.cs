...
public class GlobalVariables
{
    ...
    public static string DEFAULT_WELCOME =
        "Welcome to the FOXhole. Read the Message of the Day for Infos - Questions, ask us! Guides & Tools on our Homepage: http://www.gw2fox.com";
    public static string DEFAULT_GUILD =
        "\u2620 Young or old [FOX], we take every stray. Humor, respect and fun at the game are what distinguish us. No Obligations! Infos: wsp me or http://www.gw2fox.com \u263b";
