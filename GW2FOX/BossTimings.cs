namespace GW2FOX
{
    public static class BossTimings
    {
        ...
        static BossTimings()
        {
            ...
            AddBossEvent("LLLA Timberline Falls", "01:20:00", 6, "WBs");
            AddBossEvent("LLLA Iron Marches", "03:20:00", 6, "WBs", "[&BOcBAAA=]");
            AddBossEvent("LLLA Gendarran Fields", "05:20:00", 6, "WBs");
        ...
        public class BossEventGroup
        {
            ...
            {
                var nextTimings = _timings
                    .Distinct(new BossEventComparer())
        ...
        public class BossEvent(string bossName, TimeSpan timing, string category, string waypoint = "")
        {
            ...
            public TimeSpan Timing { get; } = timing;
