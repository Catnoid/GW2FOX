...
namespace GW2FOX
{
    public partial class DredgeCommissar : BaseForm
    {
        ...
        private void InitializeItemPriceTextBox()
        {
            ...
            DredgeCommissarCost.Text = "Item-Preis: Wird geladen...";
            DredgeCommissarCost.AutoSize = true;
            DredgeCommissarCost.ReadOnly = true;
            DredgeCommissarCost.Location = new Point(/* Specify the X and Y coordinates */);
            Controls.Add(DredgeCommissarCost);
        }
        ...
        {
            Clipboard.SetText(DredgeCommissarCost.Text);
            BringGw2ToFront();
        }
